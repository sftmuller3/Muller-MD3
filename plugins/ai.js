...
cmd({
    ...
    try {
        ...
        if (!q) return reply("⚠️ pls ask something.\n\nExample:\n.gpt What is AI?");
        ...
        // Image AI à envoyer
        const ALIVE_IMG = 'https://files.catbox.moe/hqj7mh.png'; // Remplacez par l'URL de votre image AI
...
cmd({
    ...
    try {
        ...
        // AI image to attach
        const AI_IMG = 'https://files.catbox.moe/2b6m4m.jpg'; // Replace with a valid image URL
