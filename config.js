...
global.anitav4 = process.env.BOT_NAME || "Muller-MD";
global.ownername = process.env.OWNER_NAME || "SFT MULLER";
global.packname = process.env.PACK_NAME || "Muller-MD";
global.author = process.env.AUTHOR || "SFT MULLER";
global.channelname = process.env.CHANNEL_NAME || "SFT MULLER";
