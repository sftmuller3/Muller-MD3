...
const sessdata = config.SESSION_ID.replace("MULLER;;;", '');
...
console.log('MULLER CONNECTED TO WHATSAPP ENJOY ✅')

let up = `*╭──────────────●●*
> *➺ MULLER MD ᴄᴏɴɴᴇᴄᴛᴇᴅ sᴜᴄᴄᴇssғᴜʟʏ ᴛʏᴘᴇ .ᴍᴇɴᴜ ᴛᴏ sᴇᴇ ᴛʜᴇ ғᴜʟʟ ᴄᴏᴍᴍᴀɴᴅ ʟɪsᴛ🔖*
